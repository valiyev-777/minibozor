...
private val GLYPHS: Map<String, List<String>> = mapOf(
    ...
    "shield" to listOf(
        "M12 3.4 19 6v5.4c0 4.2-2.8 7.7-7 9.2-4.2-1.5-7-5-7-9.2V6z",
        "M9.1 12.1 11.3 14.3 15 10.4",
    ),
    "arrow-down" to listOf(
        "M12 5.2v13.6",
        "M6.8 13.6 12 18.8 17.2 13.6",
    ),
    "cart-check" to listOf(
        "M4.2 9.6h15.6l-1.6 9.1a1.6 1.6 0 0 1-1.6 1.3H7.4a1.6 1.6 0 0 1-1.6-1.3z",
        "M8.6 9.6 10 4.6M15.4 9.6 14 4.6",
        "M9.6 14.4 11.6 16.4 15 12.8",
    ),
    "close" to listOf(
        "M6.6 6.6l10.8 10.8",
        "M17.4 6.6 6.6 17.4",
