...
export const t = {
  ...
  orders: "Buyurtmalar",
  order: "Buyurtma",
  pickups: "Yig'uv reyslari",
  removals: "Olib ketish",
  stock: "Qoldiq harakati",
  ...
  suppliesEmptyHint: "Sotuvchi tovar topshirsa, partiya shu yerda paydo bo'ladi.",
  seller: "Sotuvchi",
  ...
  restock: "Javonga qaytarildi",
  restockAsk: "Tovar javonga qaytarildimi?",
  restockYes: "Ha — javonga",
  restockNo: "Yo'q — hisobdan",
  inspect: "Tekshirish",
  ...
  // pickups
  pickupsEmpty: "Reys yo'q",
  pickupsEmptyHint: "Tasdiqlangan qaytarish uchun kuryer reysi shu yerda tuziladi.",
  newPickup: "Yangi reys",
  pickupCreated: "Reys tuzildi",
  ...
  productsWaiting: "Sanoq kutayotgan kartochkalar",
  editCard: "Kartochkani tuzatish",
  editHint:
