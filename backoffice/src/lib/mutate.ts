 ...
 * translated and already specific — "placed holatidan shipped holatiga o'tib
 * bo'lmaydi", "Bu ariza allaqachon tekshirilgan". That text goes straight into
 * the toast. There is no "something went wrong" in this codebase; on a screen
 * where somebody is moving other people's goods, a shrug is worse than no
 * message at all.
 */
