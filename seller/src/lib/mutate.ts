 ...
 * translated and already specific — "Bu sizning taklifingiz emas", "Javonda
 * tovar bor". That text goes straight into the toast. There is no "something
 * went wrong" in this codebase; on the screen where somebody reads their own
 * money, a shrug is worse than no message at all.
 */
