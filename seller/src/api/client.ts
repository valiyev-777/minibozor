 ...
 *
 * A copy of the backoffice's client rather than a shared package, and that is
 * the decision rather than an accident. Two applications, two bundles, two
 * deployments, two origins — a shared module would need a workspace, a build
 * step and a version to keep them in step, which is more machinery than the
 * eighty lines it would save. They are allowed to drift: this one will grow a
 * seller's concerns and that one an operator's.
 *
...
/**
 * The sentence to put in front of the seller.
 *
