 ...
 * can sign in here would be looking at a seller's account through a door
...
export function SessionProvider({ children }: { children: React.ReactNode }) {
   ...
   * backoffice am I" endpoint — so the check is here, and it says which role
   * it found. Somebody quietly shown an empty screen files a bug; somebody
   * told "this is the seller's cabinet, you are an admin" goes to the right
   * place.
   */
